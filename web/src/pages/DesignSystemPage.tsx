    ...
    <div className="ds-page">
      ...
      <main className="ds-main">
        ...
        <Section id="typography" title="Typography">
          <div className="ds-type-row"><span className="ds-type-meta">Display / Source Serif 4</span><p className="ds-type-sample" style={{ fontFamily: 'var(--font-serif)', fontSize: '3rem', fontWeight: 700, lineHeight: 1.1 }}>Big decisions, real delivery.</p></div>
          <div className="ds-type-row"><span className="ds-type-meta">H2 / serif 2.25rem</span><p className="ds-type-sample" style={{ fontFamily: 'var(--font-serif)', fontSize: '2.25rem', fontWeight: 700, color: 'var(--color-primary-dark)' }}>The Solution: One Integrated System</p></div>
          <div className="ds-type-row"><span className="ds-type-meta">H3 / serif 1.25rem</span><p className="ds-type-sample" style={{ fontFamily: 'var(--font-serif)', fontSize: '1.25rem', fontWeight: 600, color: 'var(--color-primary-dark)' }}>The Engine — Sovereignty App</p></div>
          <div className="ds-type-row"><span className="ds-type-meta">Lead / sans 1.1875rem</span><p className="ds-type-sample" style={{ fontSize: '1.1875rem', color: 'var(--color-text-muted)', maxWidth: '48rem' }}>A $1.2M, 24-month programme — entered through a $60,000, 6-month Foundation Phase in Kazakhstan that delivers a working solution before any further funding is asked.</p></div>
          <div className="ds-type-row"><span className="ds-type-meta">Body / sans 1rem</span><p className="ds-type-sample" style={{ maxWidth: '48rem' }}>The Hub turns political will into lung-health action — a fast, governed platform built on the Global TB Caucus network across nine countries in Eastern Europe & Central Asia. AI is an enabling tool with human review at every step, never the decision-maker.</p></div>
        ...
        <Section id="components" title="Components">
          ...
          <div className="ds-row-dark">
            <aside className="hero-statcard" style={{ maxWidth: '26rem' }}>
              ...
              <p className="statcard-text">A $1.2M, 24-month programme, entered at a $60k Foundation Phase.</p>
              <ul className="statgrid">
                ...
                <li><strong>$1.2M</strong><span>over 24 months</span></li>
              </ul>
            </aside>
          </div>
        </Section>
